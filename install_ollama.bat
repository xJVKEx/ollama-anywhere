...
setx OLLAMA_MODELS "%MODELS_DIR%" > nul || goto ERROR
...
if %errorlevel% neq 0 (
    echo [!] Local installation exited with error code: %errorlevel%
    goto ERROR
)
goto END_INSTALL
...
echo.
echo =====================================================================
echo [!] FAILURE: An error occurred during script execution.
echo =====================================================================
echo.
echo Press any key to exit...
pause > nul
